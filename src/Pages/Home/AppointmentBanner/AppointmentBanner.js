          ...
          <Grid item xs={12} md={6} sx={{
            ...
            <Box>
                ...
                <Typography variant="h6" sx={{my: 4}} style={{color: 'white', fontSize: 14, fontWeight: 300}}>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Exercitationem pariatur eius, voluptates officiis placeat consequatur? Quas omnis quod molestiae neque!
                </Typography>
